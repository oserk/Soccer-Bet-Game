...
var Loader = (function () {
    ...
    ***************************************************************************** */
    ...
    var C__Users_Chad_repos_resourceLoader_node_modules_parseUri = function parseURI (str, opts) {
      opts = opts || {};
    ...
    var Resource = (function () {
        ...
        Resource.prototype._determineCrossOrigin = function (url, loc) {
            ...
            var parsed = C__Users_Chad_repos_resourceLoader_node_modules_parseUri(Resource._tempAnchor.href, { strictMode: true });
    ...
    var Loader = (function () {
        ...
        Loader.prototype._prepareUrl = function (url, baseUrl) {
            var parsed = C__Users_Chad_repos_resourceLoader_node_modules_parseUri(url, { strictMode: true });
            this._urlResolvers.forEach(function (resolver) {
                url = resolver(url, parsed);
                parsed = C__Users_Chad_repos_resourceLoader_node_modules_parseUri(url, { strictMode: true });
            });
    ...
    Object.defineProperties(Loader, {
        AbstractLoadStrategy: { get: function () { return AbstractLoadStrategy; } },
        AudioLoadStrategy: { get: function () { return AudioLoadStrategy; } },
        ImageLoadStrategy: { get: function () { return ImageLoadStrategy; } },
        MediaElementLoadStrategy: { get: function () { return MediaElementLoadStrategy; } },
        VideoLoadStrategy: { get: function () { return VideoLoadStrategy; } },
        XhrLoadStrategy: { get: function () { return XhrLoadStrategy; } },
        Resource: { get: function () { return Resource; } },
        ResourceType: { get: function () { return ResourceType; } },
        ResourceState: { get: function () { return ResourceState; } },
        async: { get: function () { return { AsyncQueue: AsyncQueue, eachSeries: eachSeries }; } },
        getExtension: { get: function () { return getExtension; } },
    });
